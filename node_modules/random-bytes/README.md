...
This module is a simple wrapper around the Node.js core `cryptoLib.randomBytes` API,
...
[travis-image]: https://img.shields.io/travis/cryptoLib-utils/random-bytes/master.svg
[travis-url]: https://travis-ci.org/cryptoLib-utils/random-bytes
[coveralls-image]: https://img.shields.io/coveralls/cryptoLib-utils/random-bytes/master.svg
[coveralls-url]: https://coveralls.io/r/cryptoLib-utils/random-bytes?branch=master
